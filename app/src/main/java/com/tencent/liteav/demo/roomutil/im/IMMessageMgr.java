...
/**
 *    todo 初始化IMSDK 就是初始化聊天系统的sdk,初始化代码如下 ,
 *    其中 new TIMCallBack() 这个是个接口回调,如果登录成功就回调onSuccess()方法,失败就回调onError()方法.
 *       public void login(String identifier, String userSig, TIMUserConfig userConfig, TIMCallBack cb) {
 IMContext.getInstance().getUser(this.mIdentifier).login(identifier, userSig, userConfig, cb);
 }
 05-07 10:16:47.189 6562-6562/com.tencent.liteav.demo I/IMMessageMgr: start login: userId = 自己定义的用户名
 05-07 10:16:47.190 6562-6562/com.tencent.liteav.demo I/IMUser: Login|1-Begin|Succ|identifer=自己定义的用户名, sdkappid=1400047134
 05-07 10:16:47.191 6562-6562/com.tencent.liteav.demo D/QALSDKManager: login:自己定义的用户名
 */
