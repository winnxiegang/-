...
public class LiveRoomListFragment extends Fragment {
        ...
        new AlertDialog.Builder(activity, R.style.RtmpRoomDialogTheme)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (text != null) {//这里的name是动态随机设置的 。理论上是自己的注册名字
    ...
    private void createRoom(final String roomName) {//String name="谢刚";
        RoomInfo roomInfo = new RoomInfo();
        roomInfo.roomInfo = roomName;
        roomInfo.roomID = "xiegang_id_test";
        roomInfo.roomName = roomName;
        Log.d("room", roomInfo.roomID + "");
        Log.d("room", roomInfo.roomName + "");//这里就name不是空的其他的都是空的room_1525663156213_7850

        // todo 创建之后 再进入房间和把信息带进去 LiveRoomChatFragment  true  是请求创建房间 false 是  表明是进入其他别人创建的房间
